...
struct VINSOptions {
  ...
  int enable_zupt = 0;
  double raw_odometry_confirmation_step_m = 0.0;
  ///////////////////////////////////////////////////////////////////////////
  ...
  void readParameters(const std::string& config_file) {
    ...
    if (!fsSettings["raw_odometry_confirmation_step_m"].empty()) {
      this->raw_odometry_confirmation_step_m =
          (double)fsSettings["raw_odometry_confirmation_step_m"];
      if (!std::isfinite(this->raw_odometry_confirmation_step_m) ||
          this->raw_odometry_confirmation_step_m < 0.0) {
        throw std::invalid_argument(
            "raw_odometry_confirmation_step_m must be finite and non-negative");
      }
    }
  ...
  double rawOdometryConfirmationStepM() const {
    return raw_odometry_confirmation_step_m;
  }

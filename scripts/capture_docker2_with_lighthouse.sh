...
FROZEN_LIGHTHOUSE_CONFIG="$ROOT_DIR/reports/lighthouse_recalibration_world_v11_20260916_consensus/libsurvive_config_frozen_v11.json"
FROZEN_LIGHTHOUSE_CONFIG_SHA256="13c3b7efae550da06a41c183664107996f8cdb36efafc299c4582d8f32f41f58"
DURATION_S="${1:-60}"
LABEL="${2:-calibration}"

...
FROZEN_LIGHTHOUSE_CONFIG="$ROOT_DIR/reports/lighthouse_recalibration_world_v13_20260926_consensus/libsurvive_config_frozen_v13.json"
FROZEN_LIGHTHOUSE_CONFIG_SHA256="8b2f50ed5bf51ee4366d155dd99983a7a2791b1de4b7995d375d5036b94668d0"
DURATION_S="${1:-60}"
LABEL="${2:-calibration}"
